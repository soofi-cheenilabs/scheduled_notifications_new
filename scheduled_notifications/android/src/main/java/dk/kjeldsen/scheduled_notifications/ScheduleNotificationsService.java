    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent != null) {
            ...
            if (scheduleNotification != null) {
                ...
                try {
                        Bitmap large_notification_icon = BitmapFactory.decodeResource( 
                                this.getApplicationContext().getResources(), R.drawable.reward_cave_icon);
                    ...
                    builder.setContentIntent(contentIntent)
                            ...
                            .setSmallIcon(R.drawable.reward_cave_small_notification_icon)
